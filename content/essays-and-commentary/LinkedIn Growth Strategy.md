---
title: The LinkedIn Growth Architecture
date: 2026-05-23
maturity: Sapling
publish: false
---
...
1.  **Who is the specific target?** (Ideal Customer Profile)
2.  **What problem is solved?** (Value Proposition)
3.  **What is the expected outcome?** (The Transformation)
...
- **20 Comments:** Engaging with large creators and players to borrow visibility and establish presence.
...
* What is the relationship between `[[Dwell Time]]` on a post and the effectiveness of long-form "meat" vs. short-form hooks?
* Should we develop a `[[Hook Library]]` to categorize different psychological triggers (e.g., Negativity Bias vs. Curiosity Gap)?

## References
- [The LinkedIn Algorithm Research](https://www.justconnecting.nl/) - Annual research by Richard van der Blom.
- [Building a StoryBrand](https://storybrand.com/) - Donald Miller's framework on "The Hero" (Customer) vs. "The Guide" (Brand).
- [Jab, Jab, Jab, Right Hook](https://garyvaynerchuk.com/books/jab-jab-jab-right-hook/) - Gary Vaynerchuk's foundational text on the value-first content ratio.