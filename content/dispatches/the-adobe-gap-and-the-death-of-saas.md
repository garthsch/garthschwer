---
title: The Adobe Gap and the Death of SaaS
tags:
  - linked-in-posts
  - shadow-it
  - saas
...
- As AI agents commoditize task-specific tools, what happens to the vendor relationships and trust patterns that SaaS built their entire business model around?
- If every employee becomes capable of generating "good enough" solutions, how does organizational knowledge consolidate or degrade when that code lives in isolated local environments?
- Are we entering a phase where security investments in procurement and governance become inversely valuable — the better your controls, the more friction you create for adoption of the very tools meant to secure you?
- What's the difference between yesterday's shadow IT crisis (unauthorized SaaS subscriptions) and tomorrow's (thousands of undocumented AI-generated utilities), and do our current audit frameworks even detect the latter?
